...
func (d Dummyᐸᐳ) newBlockᐸDummyᐸᐳᐳ(value Dummyᐸᐳ) BlockᐸDummyᐸᐳᐳ { return BlockᐸDummyᐸᐳᐳ{value, &sync.Mutex{}};
 };
...
func (d Dummyᐸᐳ) Mainᐸᐳ() Dummyᐸᐳ { bc := BlockChainᐸDummyᐸᐳᐳ{Dummyᐸᐳ{}.newBlockᐸDummyᐸᐳᐳ(Dummyᐸᐳ{}), Dummyᐸᐳ{}.newBlockᐸDummyᐸᐳᐳ(Dummyᐸᐳ{})};
go bc.chain_infoᐸᐳ();
_ = bc.commitᐸᐳ();
return Dummyᐸᐳ{};
 };
