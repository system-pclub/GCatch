...
1. Clone the [tools](https://github.com/system-pclub/GCatch/GCatch/tools) subrepository.
...
import (
	...
	"github.com/system-pclub/GCatch/GCatch/tools/internal/event/export/metric"
	"github.com/system-pclub/GCatch/GCatch/tools/internal/event/export/ocagent"
)
