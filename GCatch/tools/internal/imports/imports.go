...
// Options is github.com/system-pclub/GCatch/GCatch/tools/imports.Options with extra internal-only options.
type Options struct {
...
// Process implements github.com/system-pclub/GCatch/GCatch/tools/imports.Process with explicit context in opt.Env.
