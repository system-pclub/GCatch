...
import (
	...
	"github.com/system-pclub/GCatch/GCatch/tools/internal/lsp/foo" //@link(`github.com/system-pclub/GCatch/GCatch/tools/internal/lsp/foo`,`https://pkg.go.dev/github.com/system-pclub/GCatch/GCatch/tools/internal/lsp/foo?utm_source=gopls`)
