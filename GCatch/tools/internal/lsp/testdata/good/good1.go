...
import (
	"github.com/system-pclub/GCatch/GCatch/tools/internal/lsp/types" //@item(types_import, "types", "\"github.com/system-pclub/GCatch/GCatch/tools/internal/lsp/types\"", "package")
)
