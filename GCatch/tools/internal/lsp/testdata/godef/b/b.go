...
import (
	myFoo "github.com/system-pclub/GCatch/GCatch/tools/internal/lsp/foo" //@mark(myFoo, "myFoo"),godef("myFoo", myFoo)
	"github.com/system-pclub/GCatch/GCatch/tools/internal/lsp/godef/a"   //@mark(AImport, re"\".*\"")
)
