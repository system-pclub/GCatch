...
import (
	...
	"github.com/system-pclub/GCatch/GCatch/tools/internal/lsp/baz"
	_ "github.com/system-pclub/GCatch/GCatch/tools/internal/lsp/signature" // provide type information for unimported completions in the other file
)
