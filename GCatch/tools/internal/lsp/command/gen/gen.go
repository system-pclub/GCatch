...
import (
	...
	"github.com/system-pclub/GCatch/GCatch/tools/internal/lsp/command/commandmeta"
)
...
func Generate() ([]byte, error) {
	...
	d := data{
		...
		Imports: map[string]bool{
			"context": true,
			"fmt":     true,
			"github.com/system-pclub/GCatch/GCatch/tools/internal/lsp/protocol": true,
		},
	}
	const thispkg = "github.com/system-pclub/GCatch/GCatch/tools/internal/lsp/command"
