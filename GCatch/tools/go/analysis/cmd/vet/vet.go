...
// analyzers defined using the github.com/system-pclub/GCatch/GCatch/tools/go/analysis API, and
// using the github.com/system-pclub/GCatch/GCatch/tools/go/packages API to load packages in any
// build system.
//
