...
// error message.
//
package analysis // import "github.com/system-pclub/GCatch/GFix/dispatcher/tools/godoc/analysis"
...
func Run(pta bool, result *Result) {
	...
	//args = []string{"github.com/system-pclub/GCatch/GFix/dispatcher/tools/cmd/godoc"}
	//args = []string{"fmt"}
