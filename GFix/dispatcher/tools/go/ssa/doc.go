...
// to load typed syntax trees using github.com/system-pclub/GCatch/GFix/dispatcher/prepare/packages, then
...
//
package ssa // import "github.com/system-pclub/GCatch/GFix/dispatcher/tools/go/ssa"
