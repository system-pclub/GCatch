...
import (
	...
	"github.com/system-pclub/GCatch/GFix/dispatcher/tools/go/analysis/internal/checker"
...
// directory using github.com/system-pclub/GCatch/GFix/dispatcher/tools/go/packages, runs the analysis on
