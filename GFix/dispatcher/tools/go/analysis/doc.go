...
(see the "Standalone commands" section for details).
	...
	$ go build github.com/system-pclub/GCatch/GFix/dispatcher/tools/go/analysis/cmd/vet
	$ ./vet help
...
github.com/system-pclub/GCatch/GFix/dispatcher/tools/go/cfg); the "inspect" analyzer returns a value that
