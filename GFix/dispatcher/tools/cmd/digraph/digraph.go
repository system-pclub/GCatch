...
//
package main // import "github.com/system-pclub/GCatch/GFix/dispatcher/tools/cmd/digraph"
...
Example usage:
   ...
   % go list -f '{{.ImportPath}}{{.Imports}}' ... | tr '[]' '  ' |
         digraph forward github.com/system-pclub/GCatch/GFix/dispatcher/tools/cmd/digraph
